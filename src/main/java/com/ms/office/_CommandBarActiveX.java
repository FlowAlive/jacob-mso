...
public class _CommandBarActiveX extends Dispatch {

  public static final String componentName = "Office._CommandBarActiveX";
   ...
   */
  public _CommandBarActiveX(Dispatch d) {
  ...
  public _CommandBarActiveX(String compName) {
    super(compName);
  }
   ...
   * @return the result is of type String
   */
  public String getControlCLSID() {
    return Dispatch.get(this, "ControlCLSID").toString();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param controlCLSID an input-parameter of type String
   */
  public void setControlCLSID(String controlCLSID) {
    Dispatch.put(this, "ControlCLSID", controlCLSID);
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param bstrIid an input-parameter of type String
   * @return the result is of type Variant
   */
  public Variant getQueryControlInterface(String bstrIid) {
    return Dispatch.call(this, "QueryControlInterface", bstrIid);
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param pUnk an input-parameter of type Variant
   */
  public void setInnerObjectFactory(Variant pUnk) {
    Dispatch.call(this, "SetInnerObjectFactory", pUnk);
  }
  ...
  public void ensureControl() {
    Dispatch.call(this, "EnsureControl");
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param initWith an input-parameter of type Variant
   */
  public void setInitWith(Variant initWith) {
    Dispatch.put(this, "InitWith", initWith);
  }
