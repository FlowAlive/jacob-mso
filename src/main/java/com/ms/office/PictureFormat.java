...
public class PictureFormat extends Dispatch {
  ...
  public static final String componentName = "Office.PictureFormat";
  ...
  public int getColorType() {
    return Dispatch.get(this, "ColorType").changeType(Variant.VariantInt).getInt();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param colorType an input-parameter of type int
   */
  public void setColorType(int colorType) {
    Dispatch.put(this, "ColorType", new Variant(colorType));
  }
  ...
  public int getTransparentBackground() {
    return Dispatch.get(this, "TransparentBackground").changeType(Variant.VariantInt).getInt();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param transparentBackground an input-parameter of type int
   */
  public void setTransparentBackground(int transparentBackground) {
    Dispatch.put(this, "TransparentBackground", new Variant(transparentBackground));
  }
