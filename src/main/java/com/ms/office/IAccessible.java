...
public class IAccessible extends Dispatch {

  public static final String componentName = "Office.IAccessible";
  ...
  public IAccessible(String compName) {
    super(compName);
  }
