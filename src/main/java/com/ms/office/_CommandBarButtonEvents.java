...
public class _CommandBarButtonEvents extends Dispatch {

  public static final String componentName = "Office._CommandBarButtonEvents";

  public _CommandBarButtonEvents() {
    super(componentName);
  }
   ...
   */
  public _CommandBarButtonEvents(Dispatch d) {
  ...
  public _CommandBarButtonEvents(String compName) {
    super(compName);
  }
