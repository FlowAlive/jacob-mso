...
public class ShapeRange extends Dispatch {
  ...
  public static final String componentName = "Office.ShapeRange";
  ...
  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param alignCmd an input-parameter of type int
   * @param relativeTo an input-parameter of type int
   */
  public void align(int alignCmd, int relativeTo) {
    Dispatch.call(this, "Align", new Variant(alignCmd), new Variant(relativeTo));
  }
  ...
  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param distributeCmd an input-parameter of type int
   * @param relativeTo an input-parameter of type int
   */
  public void distribute(int distributeCmd, int relativeTo) {
    Dispatch.call(this, "Distribute", new Variant(distributeCmd), new Variant(relativeTo));
  }
