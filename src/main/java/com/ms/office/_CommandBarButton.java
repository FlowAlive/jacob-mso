...
public class _CommandBarButton extends Dispatch {

  public static final String componentName = "Office._CommandBarButton";
   ...
   */
  public _CommandBarButton(Dispatch d) {
  ...
  public _CommandBarButton(String compName) {
    super(compName);
  }
  ...
  public boolean getBuiltInFace() {
    return Dispatch.get(this, "BuiltInFace").changeType(Variant.VariantBoolean).getBoolean();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param builtInFace an input-parameter of type boolean
   */
  public void setBuiltInFace(boolean builtInFace) {
    Dispatch.put(this, "BuiltInFace", new Variant(builtInFace));
  }
  ...
  public int getFaceId() {
    return Dispatch.get(this, "FaceId").changeType(Variant.VariantInt).getInt();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param faceId an input-parameter of type int
   */
  public void setFaceId(int faceId) {
    Dispatch.put(this, "FaceId", new Variant(faceId));
  }
  ...
  public String getShortcutText() {
    return Dispatch.get(this, "ShortcutText").toString();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param shortcutText an input-parameter of type String
   */
  public void setShortcutText(String shortcutText) {
    Dispatch.put(this, "ShortcutText", shortcutText);
  }
  ...
  public int getHyperlinkType() {
    return Dispatch.get(this, "HyperlinkType").changeType(Variant.VariantInt).getInt();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param hyperlinkType an input-parameter of type int
   */
  public void setHyperlinkType(int hyperlinkType) {
    Dispatch.put(this, "HyperlinkType", new Variant(hyperlinkType));
  }
