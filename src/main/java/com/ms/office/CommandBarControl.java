...
public class CommandBarControl extends Dispatch {

  public static final String componentName = "Office.CommandBarControl";
   ...
   */
  public CommandBarControl(Dispatch d) {
  ...
  public CommandBarControl(String compName) {
    super(compName);
  }
