...
public class Dictionaries extends Dispatch {

  public static final String componentName = "Word.Dictionaries";
   ...
   */
  public Dictionaries(Dispatch d) {
  ...
  public Dictionaries(String compName) {
    super(compName);
  }
