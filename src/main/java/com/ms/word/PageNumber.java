...
public class PageNumber extends Dispatch {

  public static final String componentName = "Word.PageNumber";
  ...
  public PageNumber(String compName) {
    super(compName);
  }
