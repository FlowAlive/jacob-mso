...
public class Indexes extends Dispatch {
  ...
  public Index addOld(Range range, Variant headingSeparator, Variant rightAlignPageNumbers, Variant type,
                      Variant numberOfColumns, Variant accentedLetters) {
    return new Index(Dispatch.call(this, "AddOld", range, headingSeparator, rightAlignPageNumbers, type,
                                   numberOfColumns, accentedLetters).toDispatch());
  }
  ...
  public Field markEntry(Range range, Variant entry, Variant entryAutoText, Variant crossReference,
                         Variant crossReferenceAutoText, Variant bookmarkName, Variant bold, Variant italic,
                         Variant reading) {
    return new Field(Dispatch.callN(this, "MarkEntry", new Object[] {range, entry, entryAutoText, crossReference,
                                    crossReferenceAutoText, bookmarkName, bold, italic, reading}).toDispatch());
  }
  ...
  public Field markEntry(Range range, Variant entry, Variant entryAutoText, Variant crossReference,
                         Variant crossReferenceAutoText, Variant bookmarkName, Variant bold, Variant italic) {
    return new Field(Dispatch.call(this, "MarkEntry", range, entry, entryAutoText, crossReference,
                                   crossReferenceAutoText, bookmarkName, bold, italic).toDispatch());
  }
   ...
   */
  public Field markEntry(Range range, Variant entry, Variant entryAutoText, Variant crossReference,
                         Variant crossReferenceAutoText, Variant bookmarkName, Variant bold) {
    return new Field(Dispatch.call(this, "MarkEntry", range, entry, entryAutoText, crossReference,
                                   crossReferenceAutoText, bookmarkName, bold).toDispatch());
  }
   ...
   */
  public Field markEntry(Range range, Variant entry, Variant entryAutoText, Variant crossReference,
                         Variant crossReferenceAutoText, Variant bookmarkName) {
    return new Field(Dispatch.call(this, "MarkEntry", range, entry, entryAutoText, crossReference,
                                   crossReferenceAutoText, bookmarkName).toDispatch());
  }
  ...
  public Field markEntry(Range range, Variant entry, Variant entryAutoText, Variant crossReference,
    ...
    return new Field(Dispatch.call(this, "MarkEntry", range, entry, entryAutoText, crossReference,
                                   crossReferenceAutoText).toDispatch());
  }
  ...
  public Index add(Range range, Variant headingSeparator, Variant rightAlignPageNumbers, Variant type,
                   Variant numberOfColumns, Variant accentedLetters, Variant sortBy, Variant indexLanguage) {
    return new Index(Dispatch.call(this, "Add", range, headingSeparator, rightAlignPageNumbers, type, numberOfColumns,
                                   accentedLetters, sortBy, indexLanguage).toDispatch());
  }
   ...
   */
  public Index add(Range range, Variant headingSeparator, Variant rightAlignPageNumbers, Variant type,
                   Variant numberOfColumns, Variant accentedLetters, Variant sortBy) {
    return new Index(Dispatch.call(this, "Add", range, headingSeparator, rightAlignPageNumbers, type, numberOfColumns,
                                   accentedLetters, sortBy).toDispatch());
  }
