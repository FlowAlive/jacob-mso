...
public class KeyBindings extends Dispatch {
  ...
  public KeyBinding add(int keyCategory, String command, int keyCode, Variant keyCode2, Variant commandParameter) {
    return new KeyBinding(Dispatch.call(this, "Add", new Variant(keyCategory), command, new Variant(keyCode), keyCode2,
                                        commandParameter).toDispatch());
  }
  ...
  public KeyBinding add(int keyCategory, String command, int keyCode) {
    return new KeyBinding(Dispatch.call(this, "Add", new Variant(keyCategory), command, new Variant(keyCode)).
                          toDispatch());
  }
