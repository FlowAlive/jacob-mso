...
public class TableOfContents extends Dispatch {

  public static final String componentName = "Word.TableOfContents";
   ...
   */
  public TableOfContents(Dispatch d) {
  ...
  public TableOfContents(String compName) {
    super(compName);
  }
