...
public class Window extends Dispatch {
   ...
   * @param obj an input-parameter of type Object
   */
  public void getPoint(int screenPixelsLeft, int screenPixelsTop, int screenPixelsWidth, int screenPixelsHeight,
                       Object obj) {
    Dispatch.call(this, "GetPoint", new Variant(screenPixelsLeft), new Variant(screenPixelsTop),
                  new Variant(screenPixelsWidth), new Variant(screenPixelsHeight), obj);
  }
  ...
  public void getPoint(int[] screenPixelsLeft, int[] screenPixelsTop, int[] screenPixelsWidth, int[] screenPixelsHeight,
    ...
    Dispatch.call(this, "GetPoint", vnt_screenPixelsLeft, vnt_screenPixelsTop, vnt_screenPixelsWidth,
                  vnt_screenPixelsHeight, obj);
