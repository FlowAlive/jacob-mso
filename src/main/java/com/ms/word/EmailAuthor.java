...
public class EmailAuthor extends Dispatch {

  public static final String componentName = "Word.EmailAuthor";
  ...
  public EmailAuthor(String compName) {
    super(compName);
  }
