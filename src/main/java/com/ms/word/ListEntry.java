...
public class ListEntry extends Dispatch {

  public static final String componentName = "Word.ListEntry";
  ...
  public ListEntry(String compName) {
    super(compName);
  }
