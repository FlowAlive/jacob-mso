...
public class TablesOfAuthorities extends Dispatch {
  ...
  public TableOfAuthorities add(Range range, Variant category, Variant bookmark, Variant passim,
                                Variant keepEntryFormatting, Variant separator, Variant includeSequenceName,
                                Variant entrySeparator, Variant pageRangeSeparator, Variant includeCategoryHeader,
                                Variant pageNumberSeparator) {
    return new TableOfAuthorities(Dispatch.callN(this, "Add", new Object[] {range, category, bookmark, passim,
                                                 keepEntryFormatting, separator, includeSequenceName, entrySeparator,
                                                 pageRangeSeparator, includeCategoryHeader, pageNumberSeparator}).
                                  toDispatch());
  }
  ...
  public TableOfAuthorities add(Range range, Variant category, Variant bookmark, Variant passim,
    ...
    return new TableOfAuthorities(Dispatch.callN(this, "Add", new Object[] {range, category, bookmark, passim,
                                                 keepEntryFormatting, separator, includeSequenceName, entrySeparator,
                                                 pageRangeSeparator, includeCategoryHeader}).toDispatch());
  }
  ...
  public TableOfAuthorities add(Range range, Variant category, Variant bookmark, Variant passim,
                                Variant keepEntryFormatting, Variant separator, Variant includeSequenceName,
                                Variant entrySeparator, Variant pageRangeSeparator) {
    return new TableOfAuthorities(Dispatch.callN(this, "Add", new Object[] {range, category, bookmark, passim,
                                                 keepEntryFormatting, separator, includeSequenceName, entrySeparator,
                                                 pageRangeSeparator}).toDispatch());
  }
  ...
  public TableOfAuthorities add(Range range, Variant category, Variant bookmark, Variant passim,
    ...
    return new TableOfAuthorities(Dispatch.call(this, "Add", range, category, bookmark, passim, keepEntryFormatting,
                                                separator, includeSequenceName, entrySeparator).toDispatch());
  }
  ...
  public TableOfAuthorities add(Range range, Variant category, Variant bookmark, Variant passim,
                                Variant keepEntryFormatting, Variant separator, Variant includeSequenceName) {
    return new TableOfAuthorities(Dispatch.call(this, "Add", range, category, bookmark, passim, keepEntryFormatting,
                                                separator, includeSequenceName).toDispatch());
  }
   ...
   */
  public TableOfAuthorities add(Range range, Variant category, Variant bookmark, Variant passim,
                                Variant keepEntryFormatting, Variant separator) {
    return new TableOfAuthorities(Dispatch.call(this, "Add", range, category, bookmark, passim, keepEntryFormatting,
                                                separator).toDispatch());
  }
  ...
  public Field markCitation(Range range, String shortCitation, Variant longCitation, Variant longCitationAutoText,
                            Variant category) {
    return new Field(Dispatch.call(this, "MarkCitation", range, shortCitation, longCitation, longCitationAutoText,
                                   category).toDispatch());
  }
