...
public class ListParagraphs extends Dispatch {

  public static final String componentName = "Word.ListParagraphs";
   ...
   */
  public ListParagraphs(Dispatch d) {
  ...
  public ListParagraphs(String compName) {
    super(compName);
  }
