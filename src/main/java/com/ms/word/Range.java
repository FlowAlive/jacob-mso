...
public class Range extends Dispatch {
  ...
  public void setCase(int _case) {
    Dispatch.put(this, "Case", new Variant(_case));
  }
  ...
  public Table convertToTableOld(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
                                 Variant format, Variant applyBorders, Variant applyShading, Variant applyFont,
    ...
    return new Table(Dispatch.callN(this, "ConvertToTableOld", new Object[] {separator, numRows, numColumns,
                                    initialColumnWidth, format, applyBorders, applyShading, applyFont, applyColor,
  ...
  public Table convertToTableOld(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
                                 Variant format, Variant applyBorders, Variant applyShading, Variant applyFont,
                                 Variant applyColor, Variant applyHeadingRows, Variant applyLastRow,
                                 Variant applyFirstColumn, Variant applyLastColumn) {
    return new Table(Dispatch.callN(this, "ConvertToTableOld", new Object[] {separator, numRows, numColumns,
                                    initialColumnWidth, format, applyBorders, applyShading, applyFont, applyColor,
                                    applyHeadingRows, applyLastRow, applyFirstColumn, applyLastColumn}).toDispatch());
  }
  ...
  public Table convertToTableOld(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
    ...
    return new Table(Dispatch.callN(this, "ConvertToTableOld", new Object[] {separator, numRows, numColumns,
                                    initialColumnWidth, format, applyBorders, applyShading, applyFont, applyColor,
                                    applyHeadingRows, applyLastRow, applyFirstColumn}).toDispatch());
  }
  ...
  public Table convertToTableOld(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
    ...
    return new Table(Dispatch.callN(this, "ConvertToTableOld", new Object[] {separator, numRows, numColumns,
                                    initialColumnWidth, format, applyBorders, applyShading, applyFont, applyColor,
                                    applyHeadingRows, applyLastRow}).toDispatch());
  }
  ...
  public Table convertToTableOld(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
                                 Variant format, Variant applyBorders, Variant applyShading, Variant applyFont,
                                 Variant applyColor, Variant applyHeadingRows) {
    return new Table(Dispatch.callN(this, "ConvertToTableOld", new Object[] {separator, numRows, numColumns,
                                    initialColumnWidth, format, applyBorders, applyShading, applyFont, applyColor,
                                    applyHeadingRows}).toDispatch());
  }
  ...
  public Table convertToTableOld(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
                                 Variant format, Variant applyBorders, Variant applyShading, Variant applyFont) {
    return new Table(Dispatch.call(this, "ConvertToTableOld", separator, numRows, numColumns, initialColumnWidth,
                                   format, applyBorders, applyShading, applyFont).toDispatch());
  }
   ...
   */
  public Table convertToTableOld(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
                                 Variant format, Variant applyBorders, Variant applyShading) {
    return new Table(Dispatch.call(this, "ConvertToTableOld", separator, numRows, numColumns, initialColumnWidth,
                                   format, applyBorders, applyShading).toDispatch());
  }
   ...
   */
  public Table convertToTableOld(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
                                 Variant format, Variant applyBorders) {
    return new Table(Dispatch.call(this, "ConvertToTableOld", separator, numRows, numColumns, initialColumnWidth,
                                   format, applyBorders).toDispatch());
  }
  ...
  public void insertCrossReference(Variant referenceType, int referenceKind, Variant referenceItem,
                                   Variant insertAsHyperlink, Variant includePosition) {
  ...
  public void sortOld(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                      ...
                      Variant sortFieldType3, Variant sortOrder3, Variant sortColumn, Variant separator,
                      Variant caseSensitive, Variant languageID) {
    Dispatch.callN(this, "SortOld", new Object[] {excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2,
                   sortFieldType2, sortOrder2, fieldNumber3, sortFieldType3, sortOrder3, sortColumn, separator,
  ...
  public void sortOld(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                      Variant fieldNumber2, Variant sortFieldType2, Variant sortOrder2, Variant fieldNumber3,
                      Variant sortFieldType3, Variant sortOrder3, Variant sortColumn) {
    Dispatch.callN(this, "SortOld", new Object[] {excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2,
                   sortFieldType2, sortOrder2, fieldNumber3, sortFieldType3, sortOrder3, sortColumn});
  }
  ...
  public void sortOld(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                      Variant fieldNumber2, Variant sortFieldType2, Variant sortOrder2, Variant fieldNumber3,
                      Variant sortFieldType3, Variant sortOrder3) {
    Dispatch.callN(this, "SortOld", new Object[] {excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2,
                   sortFieldType2, sortOrder2, fieldNumber3, sortFieldType3, sortOrder3});
  }
  ...
  public void sortOld(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                      Variant fieldNumber2, Variant sortFieldType2, Variant sortOrder2, Variant fieldNumber3,
                      Variant sortFieldType3) {
    Dispatch.callN(this, "SortOld", new Object[] {excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2,
                   sortFieldType2, sortOrder2, fieldNumber3, sortFieldType3});
  }
   ...
   */
  public void sortOld(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                      Variant fieldNumber2, Variant sortFieldType2, Variant sortOrder2) {
    Dispatch.call(this, "SortOld", excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2, sortFieldType2,
                  sortOrder2);
  }
   ...
   */
  public void sortOld(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                      Variant fieldNumber2, Variant sortFieldType2) {
    Dispatch.call(this, "SortOld", excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2, sortFieldType2);
  }
  ...
  public void pasteSpecial(Variant iconIndex, Variant link, Variant placement, Variant displayAsIcon, Variant dataType,
                           Variant iconFileName, Variant iconLabel) {
  ...
  public void insertDatabase(Variant format, Variant style, Variant linkToSource, Variant connection,
                             Variant sQLStatement, Variant sQLStatement1, Variant passwordDocument,
                             Variant passwordTemplate, Variant writePasswordDocument, Variant writePasswordTemplate,
                             Variant dataSource, Variant from, Variant to, Variant includeFields) {
    Dispatch.callN(this, "InsertDatabase", new Object[] {format, style, linkToSource, connection, sQLStatement,
                   sQLStatement1, passwordDocument, passwordTemplate, writePasswordDocument, writePasswordTemplate,
                   dataSource, from, to, includeFields});
  }
  ...
  public void insertDatabase(Variant format, Variant style, Variant linkToSource, Variant connection,
                             Variant sQLStatement, Variant sQLStatement1, Variant passwordDocument,
                             Variant passwordTemplate, Variant writePasswordDocument, Variant writePasswordTemplate,
                             Variant dataSource, Variant from, Variant to) {
    Dispatch.callN(this, "InsertDatabase", new Object[] {format, style, linkToSource, connection, sQLStatement,
                   sQLStatement1, passwordDocument, passwordTemplate, writePasswordDocument, writePasswordTemplate,
                   dataSource, from, to});
  }
  ...
  public void insertDatabase(Variant format, Variant style, Variant linkToSource, Variant connection,
                             Variant sQLStatement, Variant sQLStatement1, Variant passwordDocument,
                             Variant passwordTemplate, Variant writePasswordDocument, Variant writePasswordTemplate,
                             Variant dataSource, Variant from) {
    Dispatch.callN(this, "InsertDatabase", new Object[] {format, style, linkToSource, connection, sQLStatement,
                   sQLStatement1, passwordDocument, passwordTemplate, writePasswordDocument, writePasswordTemplate,
                   dataSource, from});
  }
  ...
  public void insertDatabase(Variant format, Variant style, Variant linkToSource, Variant connection,
                             Variant sQLStatement, Variant sQLStatement1, Variant passwordDocument,
                             Variant passwordTemplate, Variant writePasswordDocument) {
    Dispatch.callN(this, "InsertDatabase", new Object[] {format, style, linkToSource, connection, sQLStatement,
                   sQLStatement1, passwordDocument, passwordTemplate, writePasswordDocument});
  }
   ...
   */
  public void insertDatabase(Variant format, Variant style, Variant linkToSource, Variant connection,
                             Variant sQLStatement, Variant sQLStatement1) {
    Dispatch.call(this, "InsertDatabase", format, style, linkToSource, connection, sQLStatement, sQLStatement1);
  }
  ...
  public SpellingSuggestions getSpellingSuggestions(Variant customDictionary, Variant ignoreUppercase,
          ...
          Variant customDictionary8, Variant customDictionary9, Variant customDictionary10) {
    return new SpellingSuggestions(Dispatch.callN(this, "GetSpellingSuggestions", new Object[] {customDictionary,
  ...
  public SpellingSuggestions getSpellingSuggestions(Variant customDictionary, Variant ignoreUppercase,
    ...
    return new SpellingSuggestions(Dispatch.call(this, "GetSpellingSuggestions", customDictionary, ignoreUppercase,
                                                 mainDictionary, suggestionMode, customDictionary2, customDictionary3,
                                                 customDictionary4, customDictionary5).toDispatch());
  }
  ...
  public SpellingSuggestions getSpellingSuggestions(Variant customDictionary, Variant ignoreUppercase,
    ...
    return new SpellingSuggestions(Dispatch.call(this, "GetSpellingSuggestions", customDictionary, ignoreUppercase,
                                                 mainDictionary, suggestionMode, customDictionary2).toDispatch());
  }
  ...
  public SpellingSuggestions getSpellingSuggestions(Variant customDictionary, Variant ignoreUppercase,
    ...
    return new SpellingSuggestions(Dispatch.call(this, "GetSpellingSuggestions", customDictionary, ignoreUppercase,
                                                 mainDictionary, suggestionMode).toDispatch());
  }
  ...
  public void convertHangulAndHanja(Variant conversionsMode, Variant fastConversion, Variant checkHangulEnding,
                                    Variant enableRecentOrdering, Variant customDictionary) {
  ...
  public void insertDateTime(Variant dateTimeFormat, Variant insertAsField, Variant insertAsFullWidth,
                             Variant dateLanguage, Variant calendarType) {
  ...
  public void sort(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                   Variant fieldNumber2, Variant sortFieldType2, Variant sortOrder2, Variant fieldNumber3,
                   Variant sortFieldType3, Variant sortOrder3, Variant sortColumn, Variant separator,
                   Variant caseSensitive, Variant bidiSort, Variant ignoreThe, Variant ignoreKashida,
                   Variant ignoreDiacritics, Variant ignoreHe, Variant languageID) {
    Dispatch.callN(this, "Sort", new Object[] {excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2,
                   sortFieldType2, sortOrder2, fieldNumber3, sortFieldType3, sortOrder3, sortColumn, separator,
                   caseSensitive, bidiSort, ignoreThe, ignoreKashida, ignoreDiacritics, ignoreHe, languageID});
  }
  ...
  public void sort(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                   ...
                   Variant sortFieldType3, Variant sortOrder3, Variant sortColumn, Variant separator,
                   Variant caseSensitive, Variant bidiSort, Variant ignoreThe, Variant ignoreKashida,
                   Variant ignoreDiacritics, Variant ignoreHe) {
    Dispatch.callN(this, "Sort", new Object[] {excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2,
                   sortFieldType2, sortOrder2, fieldNumber3, sortFieldType3, sortOrder3, sortColumn, separator,
                   caseSensitive, bidiSort, ignoreThe, ignoreKashida, ignoreDiacritics, ignoreHe});
  }
  ...
  public void sort(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                   ...
                   Variant sortFieldType3, Variant sortOrder3, Variant sortColumn, Variant separator,
                   Variant caseSensitive, Variant bidiSort, Variant ignoreThe, Variant ignoreKashida,
                   Variant ignoreDiacritics) {
    Dispatch.callN(this, "Sort", new Object[] {excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2,
                   sortFieldType2, sortOrder2, fieldNumber3, sortFieldType3, sortOrder3, sortColumn, separator,
                   caseSensitive, bidiSort, ignoreThe, ignoreKashida, ignoreDiacritics});
  }
  ...
  public void sort(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                   Variant fieldNumber2, Variant sortFieldType2, Variant sortOrder2, Variant fieldNumber3,
                   Variant sortFieldType3, Variant sortOrder3, Variant sortColumn, Variant separator,
                   Variant caseSensitive, Variant bidiSort, Variant ignoreThe) {
    Dispatch.callN(this, "Sort", new Object[] {excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2,
                   sortFieldType2, sortOrder2, fieldNumber3, sortFieldType3, sortOrder3, sortColumn, separator,
  ...
  public void sort(Variant excludeHeader, Variant fieldNumber, Variant sortFieldType, Variant sortOrder,
                   Variant fieldNumber2, Variant sortFieldType2, Variant sortOrder2, Variant fieldNumber3,
                   Variant sortFieldType3, Variant sortOrder3, Variant sortColumn, Variant separator,
                   Variant caseSensitive, Variant bidiSort) {
    Dispatch.callN(this, "Sort", new Object[] {excludeHeader, fieldNumber, sortFieldType, sortOrder, fieldNumber2,
                   sortFieldType2, sortOrder2, fieldNumber3, sortFieldType3, sortOrder3, sortColumn, separator,
                   caseSensitive, bidiSort});
  }
  ...
  public Table convertToTable(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
                              ...
                              Variant applyColor, Variant applyHeadingRows, Variant applyLastRow,
                              Variant applyFirstColumn, Variant applyLastColumn, Variant autoFit,
                              Variant autoFitBehavior, Variant defaultTableBehavior) {
    return new Table(Dispatch.callN(this, "ConvertToTable", new Object[] {separator, numRows, numColumns,
                                    initialColumnWidth, format, applyBorders, applyShading, applyFont, applyColor,
                                    applyHeadingRows, applyLastRow, applyFirstColumn, applyLastColumn, autoFit,
                                    autoFitBehavior, defaultTableBehavior}).toDispatch());
  }
  ...
  public Table convertToTable(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
                              Variant format, Variant applyBorders, Variant applyShading, Variant applyFont) {
    return new Table(Dispatch.call(this, "ConvertToTable", separator, numRows, numColumns, initialColumnWidth, format,
                                   applyBorders, applyShading, applyFont).toDispatch());
  }
  ...
  public Table convertToTable(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth,
                              Variant format, Variant applyBorders, Variant applyShading) {
    return new Table(Dispatch.call(this, "ConvertToTable", separator, numRows, numColumns, initialColumnWidth, format,
                                   applyBorders, applyShading).toDispatch());
  }
   ...
   */
  public Table convertToTable(Variant separator, Variant numRows, Variant numColumns, Variant initialColumnWidth) {
    return new Table(Dispatch.call(this, "ConvertToTable", separator, numRows, numColumns, initialColumnWidth).
                     toDispatch());
  }
