...
public class TablesOfFigures extends Dispatch {
  ...
  public TableOfFigures addOld(Range range, Variant caption, Variant includeLabel, Variant useHeadingStyles,
                               Variant upperHeadingLevel, Variant lowerHeadingLevel, Variant useFields, Variant tableID,
                               Variant rightAlignPageNumbers, Variant includePageNumbers, Variant addedStyles) {
    return new TableOfFigures(Dispatch.callN(this, "AddOld", new Object[] {range, caption, includeLabel,
                                             useHeadingStyles, upperHeadingLevel, lowerHeadingLevel, useFields, tableID,
                                             rightAlignPageNumbers, includePageNumbers, addedStyles}).toDispatch());
  }
  ...
  public TableOfFigures addOld(Range range, Variant caption, Variant includeLabel, Variant useHeadingStyles,
                               Variant upperHeadingLevel, Variant lowerHeadingLevel, Variant useFields, Variant tableID,
                               Variant rightAlignPageNumbers, Variant includePageNumbers) {
    return new TableOfFigures(Dispatch.callN(this, "AddOld", new Object[] {range, caption, includeLabel,
                                             useHeadingStyles, upperHeadingLevel, lowerHeadingLevel, useFields, tableID,
                                             rightAlignPageNumbers, includePageNumbers}).toDispatch());
  }
  ...
  public TableOfFigures addOld(Range range, Variant caption, Variant includeLabel, Variant useHeadingStyles,
    ...
    return new TableOfFigures(Dispatch.callN(this, "AddOld", new Object[] {range, caption, includeLabel,
                                             useHeadingStyles, upperHeadingLevel, lowerHeadingLevel, useFields, tableID,
                                             rightAlignPageNumbers}).toDispatch());
  }
  ...
  public TableOfFigures addOld(Range range, Variant caption, Variant includeLabel, Variant useHeadingStyles,
                               Variant upperHeadingLevel, Variant lowerHeadingLevel, Variant useFields, Variant tableID) {
    return new TableOfFigures(Dispatch.call(this, "AddOld", range, caption, includeLabel, useHeadingStyles,
                                            upperHeadingLevel, lowerHeadingLevel, useFields, tableID).toDispatch());
  }
   ...
   */
  public TableOfFigures addOld(Range range, Variant caption, Variant includeLabel, Variant useHeadingStyles,
                               Variant upperHeadingLevel, Variant lowerHeadingLevel, Variant useFields) {
    return new TableOfFigures(Dispatch.call(this, "AddOld", range, caption, includeLabel, useHeadingStyles,
                                            upperHeadingLevel, lowerHeadingLevel, useFields).toDispatch());
  }
   ...
   */
  public TableOfFigures addOld(Range range, Variant caption, Variant includeLabel, Variant useHeadingStyles,
                               Variant upperHeadingLevel, Variant lowerHeadingLevel) {
    return new TableOfFigures(Dispatch.call(this, "AddOld", range, caption, includeLabel, useHeadingStyles,
                                            upperHeadingLevel, lowerHeadingLevel).toDispatch());
  }
  ...
  public TableOfFigures add(Range range, Variant caption, Variant includeLabel, Variant useHeadingStyles,
    ...
    return new TableOfFigures(Dispatch.callN(this, "Add", new Object[] {range, caption, includeLabel, useHeadingStyles,
                                             upperHeadingLevel, lowerHeadingLevel, useFields, tableID,
                                             rightAlignPageNumbers, includePageNumbers, addedStyles, useHyperlinks,
                                             hidePageNumbersInWeb}).toDispatch());
  }
  ...
  public TableOfFigures add(Range range, Variant caption, Variant includeLabel, Variant useHeadingStyles,
                            Variant upperHeadingLevel, Variant lowerHeadingLevel, Variant useFields, Variant tableID) {
    return new TableOfFigures(Dispatch.call(this, "Add", range, caption, includeLabel, useHeadingStyles,
                                            upperHeadingLevel, lowerHeadingLevel, useFields, tableID).toDispatch());
  }
