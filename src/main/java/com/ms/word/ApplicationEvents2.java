...
public class ApplicationEvents2 extends Dispatch {

  public static final String componentName = "Word.ApplicationEvents2";

  public ApplicationEvents2() {
    super(componentName);
  }
   ...
   */
  public ApplicationEvents2(Dispatch d) {
  ...
  public ApplicationEvents2(String compName) {
    super(compName);
  }
