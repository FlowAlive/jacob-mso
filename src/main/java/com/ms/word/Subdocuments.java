...
public class Subdocuments extends Dispatch {
  ...
  public Subdocument addFromFile(Variant name, Variant confirmConversions, Variant readOnly, Variant passwordDocument,
    ...
    return new Subdocument(Dispatch.call(this, "AddFromFile", name, confirmConversions, readOnly, passwordDocument,
  ...
  public Subdocument addFromFile(Variant name, Variant confirmConversions, Variant readOnly, Variant passwordDocument,
                                 Variant passwordTemplate, Variant revert, Variant writePasswordDocument) {
    return new Subdocument(Dispatch.call(this, "AddFromFile", name, confirmConversions, readOnly, passwordDocument,
                                         passwordTemplate, revert, writePasswordDocument).toDispatch());
  }
  ...
  public Subdocument addFromFile(Variant name, Variant confirmConversions, Variant readOnly, Variant passwordDocument,
    ...
    return new Subdocument(Dispatch.call(this, "AddFromFile", name, confirmConversions, readOnly, passwordDocument,
                                         passwordTemplate, revert).toDispatch());
  }
