...
public class MailMergeFields extends Dispatch {
  ...
  public MailMergeField addIf(Range range, String mergeField, int comparison, Variant compareTo, Variant trueAutoText,
                              Variant trueText, Variant falseAutoText, Variant falseText) {
    return new MailMergeField(Dispatch.call(this, "AddIf", range, mergeField, new Variant(comparison), compareTo,
                                            trueAutoText, trueText, falseAutoText, falseText).toDispatch());
  }
   ...
   */
  public MailMergeField addIf(Range range, String mergeField, int comparison, Variant compareTo, Variant trueAutoText,
                              Variant trueText, Variant falseAutoText) {
    return new MailMergeField(Dispatch.call(this, "AddIf", range, mergeField, new Variant(comparison), compareTo,
                                            trueAutoText, trueText, falseAutoText).toDispatch());
  }
  ...
  public MailMergeField addIf(Range range, String mergeField, int comparison, Variant compareTo, Variant trueAutoText,
                              Variant trueText) {
    return new MailMergeField(Dispatch.call(this, "AddIf", range, mergeField, new Variant(comparison), compareTo,
                                            trueAutoText, trueText).toDispatch());
  }
  ...
  public MailMergeField addNextIf(Range range, String mergeField, int comparison, Variant compareTo) {
    return new MailMergeField(Dispatch.call(this, "AddNextIf", range, mergeField, new Variant(comparison), compareTo).
                              toDispatch());
  }
  ...
  public MailMergeField addSkipIf(Range range, String mergeField, int comparison, Variant compareTo) {
    return new MailMergeField(Dispatch.call(this, "AddSkipIf", range, mergeField, new Variant(comparison), compareTo).
                              toDispatch());
  }
