...
public class TablesOfContents extends Dispatch {
  ...
  public TableOfContents addOld(Range range, Variant useHeadingStyles, Variant upperHeadingLevel,
                                Variant lowerHeadingLevel, Variant useFields, Variant tableID,
                                Variant rightAlignPageNumbers, Variant includePageNumbers, Variant addedStyles) {
    return new TableOfContents(Dispatch.callN(this, "AddOld", new Object[] {range, useHeadingStyles, upperHeadingLevel,
                                              lowerHeadingLevel, useFields, tableID, rightAlignPageNumbers,
                                              includePageNumbers, addedStyles}).toDispatch());
  }
  ...
  public TableOfContents addOld(Range range, Variant useHeadingStyles, Variant upperHeadingLevel,
    ...
    return new TableOfContents(Dispatch.call(this, "AddOld", range, useHeadingStyles, upperHeadingLevel,
                                             lowerHeadingLevel, useFields, tableID, rightAlignPageNumbers,
                                             includePageNumbers).toDispatch());
  }
  ...
  public TableOfContents addOld(Range range, Variant useHeadingStyles, Variant upperHeadingLevel,
    ...
    return new TableOfContents(Dispatch.call(this, "AddOld", range, useHeadingStyles, upperHeadingLevel,
                                             lowerHeadingLevel, useFields, tableID, rightAlignPageNumbers).toDispatch());
  }
  ...
  public TableOfContents addOld(Range range, Variant useHeadingStyles, Variant upperHeadingLevel,
                                Variant lowerHeadingLevel, Variant useFields, Variant tableID) {
    return new TableOfContents(Dispatch.call(this, "AddOld", range, useHeadingStyles, upperHeadingLevel,
                                             lowerHeadingLevel, useFields, tableID).toDispatch());
  }
   ...
   */
  public TableOfContents addOld(Range range, Variant useHeadingStyles, Variant upperHeadingLevel,
                                Variant lowerHeadingLevel, Variant useFields) {
    return new TableOfContents(Dispatch.call(this, "AddOld", range, useHeadingStyles, upperHeadingLevel,
                                             lowerHeadingLevel, useFields).toDispatch());
  }
  ...
  public TableOfContents add(Range range, Variant useHeadingStyles, Variant upperHeadingLevel,
    ...
    return new TableOfContents(Dispatch.callN(this, "Add", new Object[] {range, useHeadingStyles, upperHeadingLevel,
                                              lowerHeadingLevel, useFields, tableID, rightAlignPageNumbers,
  ...
  public TableOfContents add(Range range, Variant useHeadingStyles, Variant upperHeadingLevel,
    ...
    return new TableOfContents(Dispatch.callN(this, "Add", new Object[] {range, useHeadingStyles, upperHeadingLevel,
                                              lowerHeadingLevel, useFields, tableID, rightAlignPageNumbers,
                                              includePageNumbers, addedStyles, useHyperlinks}).toDispatch());
  }
  ...
  public TableOfContents add(Range range, Variant useHeadingStyles, Variant upperHeadingLevel,
                             Variant lowerHeadingLevel, Variant useFields, Variant tableID,
                             Variant rightAlignPageNumbers, Variant includePageNumbers) {
    return new TableOfContents(Dispatch.call(this, "Add", range, useHeadingStyles, upperHeadingLevel, lowerHeadingLevel,
                                             useFields, tableID, rightAlignPageNumbers, includePageNumbers).toDispatch());
  }
  ...
  public TableOfContents add(Range range, Variant useHeadingStyles, Variant upperHeadingLevel,
                             ...
                             Variant rightAlignPageNumbers) {
    return new TableOfContents(Dispatch.call(this, "Add", range, useHeadingStyles, upperHeadingLevel, lowerHeadingLevel,
                                             useFields, tableID, rightAlignPageNumbers).toDispatch());
  }
