...
import com.ms.office.MsoSegmentType;
...
public class ShapeNodes extends Dispatch {
  ...
  public void insert(int index, MsoSegmentType segmentType, MsoEditingType editingType, float x1, float y1, float x2,
    ...
    Dispatch.callN(this, "Insert", new Object[] {new Variant(index), segmentType, editingType, new Variant(x1),
                   new Variant(y1), new Variant(x2), new Variant(y2), new Variant(x3), new Variant(y3)});
  }
