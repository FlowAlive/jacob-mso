...
import com.ms.office.AnswerWizard;
import com.ms.office.Assistant;
import com.ms.office.COMAddIns;
import com.ms.office.CommandBars;
import com.ms.office.FileSearch;
import com.ms.office.LanguageSettings;
import com.ms.office.MsoFeatureInstall;

public class Application extends Dispatch {
  ...
  public Application(String compName) {
    super(compName);
  }
  ...
  public KeysBoundTo getKeysBoundTo(int keyCategory, String command, Variant commandParameter) {
    return new KeysBoundTo(Dispatch.call(this, "KeysBoundTo", new Variant(keyCategory), command, commandParameter).
                           toDispatch());
  }
  ...
  public void printOutOld(Variant background, Variant append, Variant range, Variant outputFileName, Variant from,
                          ...
                          Variant printToFile, Variant collate, Variant fileName, Variant activePrinterMacGX,
    ...
    Dispatch.callN(this, "PrintOutOld", new Object[] {background, append, range, outputFileName, from, to, item, copies,
                   pages, pageType, printToFile, collate, fileName, activePrinterMacGX, manualDuplexPrint});
  }
  ...
  public void printOutOld(Variant background, Variant append, Variant range, Variant outputFileName, Variant from,
                          Variant to, Variant item, Variant copies, Variant pages, Variant pageType,
                          Variant printToFile, Variant collate, Variant fileName) {
    Dispatch.callN(this, "PrintOutOld", new Object[] {background, append, range, outputFileName, from, to, item, copies,
  ...
  public int buildKeyCode(int arg1, Variant arg2, Variant arg3, Variant arg4) {
    return Dispatch.call(this, "BuildKeyCode", new Variant(arg1), arg2, arg3, arg4).changeType(Variant.VariantInt).
            getInt();
  }
  ...
  public String getAddress(Variant name, Variant addressProperties, Variant useAutoText, Variant displaySelectDialog,
                           Variant selectDialog, Variant checkNamesDialog, Variant recentAddressesChoice,
                           Variant updateRecentAddresses) {
    return Dispatch.call(this, "GetAddress", name, addressProperties, useAutoText, displaySelectDialog, selectDialog,
                         checkNamesDialog, recentAddressesChoice, updateRecentAddresses).toString();
  }
  ...
  public String getAddress(Variant name, Variant addressProperties, Variant useAutoText, Variant displaySelectDialog,
                           Variant selectDialog, Variant checkNamesDialog, Variant recentAddressesChoice) {
    return Dispatch.call(this, "GetAddress", name, addressProperties, useAutoText, displaySelectDialog, selectDialog,
                         checkNamesDialog, recentAddressesChoice).toString();
  }
   ...
   */
  public String getAddress(Variant name, Variant addressProperties, Variant useAutoText, Variant displaySelectDialog,
                           Variant selectDialog, Variant checkNamesDialog) {
    return Dispatch.call(this, "GetAddress", name, addressProperties, useAutoText, displaySelectDialog, selectDialog,
                         checkNamesDialog).toString();
  }
  ...
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase, Variant mainDictionary,
    ...
    return Dispatch.callN(this, "CheckSpelling", new Object[] {word, customDictionary, ignoreUppercase, mainDictionary,
  ...
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase, Variant mainDictionary,
    ...
    return Dispatch.callN(this, "CheckSpelling", new Object[] {word, customDictionary, ignoreUppercase, mainDictionary,
                          customDictionary2, customDictionary3, customDictionary4, customDictionary5, customDictionary6,
                          customDictionary7, customDictionary8, customDictionary9}).changeType(Variant.VariantBoolean).
            getBoolean();
  }
  ...
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase, Variant mainDictionary,
    ...
    return Dispatch.callN(this, "CheckSpelling", new Object[] {word, customDictionary, ignoreUppercase, mainDictionary,
                          customDictionary2, customDictionary3, customDictionary4, customDictionary5, customDictionary6,
                          customDictionary7, customDictionary8}).changeType(Variant.VariantBoolean).getBoolean();
  }
  ...
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase, Variant mainDictionary,
    ...
    return Dispatch.callN(this, "CheckSpelling", new Object[] {word, customDictionary, ignoreUppercase, mainDictionary,
                          customDictionary2, customDictionary3, customDictionary4, customDictionary5, customDictionary6,
                          customDictionary7}).changeType(Variant.VariantBoolean).getBoolean();
  }
  ...
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase, Variant mainDictionary,
    ...
    return Dispatch.call(this, "CheckSpelling", word, customDictionary, ignoreUppercase, mainDictionary,
                         customDictionary2, customDictionary3, customDictionary4,
            customDictionary5).changeType(Variant.VariantBoolean).getBoolean();
  }
  ...
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase, Variant mainDictionary,
                               Variant customDictionary2, Variant customDictionary3, Variant customDictionary4) {
    return Dispatch.call(this, "CheckSpelling", word, customDictionary, ignoreUppercase, mainDictionary,
                         customDictionary2, customDictionary3, customDictionary4).changeType(Variant.VariantBoolean).
            getBoolean();
  }
  ...
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase, Variant mainDictionary,
    ...
    return Dispatch.call(this, "CheckSpelling", word, customDictionary, ignoreUppercase, mainDictionary,
                         customDictionary2, customDictionary3).changeType(Variant.VariantBoolean).getBoolean();
  }
  ...
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase, Variant mainDictionary,
    ...
    return Dispatch.call(this, "CheckSpelling", word, customDictionary, ignoreUppercase, mainDictionary,
                         customDictionary2).changeType(Variant.VariantBoolean).getBoolean();
  }
   ...
   */
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase, Variant mainDictionary) {
    return Dispatch.call(this, "CheckSpelling", word, customDictionary, ignoreUppercase,
            mainDictionary).changeType(Variant.VariantBoolean).getBoolean();
  }
  ...
  public boolean checkSpelling(String word, Variant customDictionary, Variant ignoreUppercase) {
    return Dispatch.call(this, "CheckSpelling", word, customDictionary,
            ignoreUppercase).changeType(Variant.VariantBoolean).getBoolean();
  }
  ...
  public SpellingSuggestions getSpellingSuggestions(String word, Variant customDictionary, Variant ignoreUppercase,
          Variant mainDictionary, Variant suggestionMode, Variant customDictionary2, Variant customDictionary3,
          Variant customDictionary4, Variant customDictionary5, Variant customDictionary6, Variant customDictionary7,
          Variant customDictionary8, Variant customDictionary9, Variant customDictionary10) {
    return new SpellingSuggestions(Dispatch.callN(this, "GetSpellingSuggestions", new Object[] {word, customDictionary,
                                                  ignoreUppercase, mainDictionary, suggestionMode, customDictionary2,
                                                  customDictionary3, customDictionary4, customDictionary5,
                                                  customDictionary6, customDictionary7, customDictionary8,
                                                  customDictionary9, customDictionary10}).toDispatch());
  }
  ...
  public SpellingSuggestions getSpellingSuggestions(String word, Variant customDictionary, Variant ignoreUppercase,
    ...
    return new SpellingSuggestions(Dispatch.callN(this, "GetSpellingSuggestions", new Object[] {word, customDictionary,
                                                  ignoreUppercase, mainDictionary, suggestionMode, customDictionary2,
                                                  customDictionary3, customDictionary4, customDictionary5,
                                                  customDictionary6, customDictionary7, customDictionary8}).toDispatch());
  }
  ...
  public SpellingSuggestions getSpellingSuggestions(String word, Variant customDictionary, Variant ignoreUppercase,
    ...
    return new SpellingSuggestions(Dispatch.callN(this, "GetSpellingSuggestions", new Object[] {word, customDictionary,
                                                  ignoreUppercase, mainDictionary, suggestionMode, customDictionary2,
                                                  customDictionary3, customDictionary4, customDictionary5,
                                                  customDictionary6, customDictionary7}).toDispatch());
  }
  ...
  public SpellingSuggestions getSpellingSuggestions(String word, Variant customDictionary, Variant ignoreUppercase,
          Variant mainDictionary, Variant suggestionMode, Variant customDictionary2, Variant customDictionary3,
          Variant customDictionary4, Variant customDictionary5) {
    return new SpellingSuggestions(Dispatch.callN(this, "GetSpellingSuggestions", new Object[] {word, customDictionary,
                                                  ignoreUppercase, mainDictionary, suggestionMode, customDictionary2,
                                                  customDictionary3, customDictionary4, customDictionary5}).toDispatch());
  }
  ...
  public SpellingSuggestions getSpellingSuggestions(String word, Variant customDictionary, Variant ignoreUppercase,
    ...
    return new SpellingSuggestions(Dispatch.call(this, "GetSpellingSuggestions", word, customDictionary,
                                                 ignoreUppercase, mainDictionary, suggestionMode, customDictionary2,
                                                 customDictionary3, customDictionary4).toDispatch());
  }
   ...
   */
  public SpellingSuggestions getSpellingSuggestions(String word, Variant customDictionary, Variant ignoreUppercase,
          Variant mainDictionary, Variant suggestionMode, Variant customDictionary2) {
    return new SpellingSuggestions(Dispatch.call(this, "GetSpellingSuggestions", word, customDictionary,
                                                 ignoreUppercase, mainDictionary, suggestionMode, customDictionary2).
                                   toDispatch());
  }
   ...
   */
  public SpellingSuggestions getSpellingSuggestions(String word, Variant customDictionary, Variant ignoreUppercase,
          Variant mainDictionary, Variant suggestionMode) {
    return new SpellingSuggestions(Dispatch.call(this, "GetSpellingSuggestions", word, customDictionary,
                                                 ignoreUppercase, mainDictionary, suggestionMode).toDispatch());
  }
  ...
  public SpellingSuggestions getSpellingSuggestions(String word, Variant customDictionary, Variant ignoreUppercase,
    ...
    return new SpellingSuggestions(Dispatch.call(this, "GetSpellingSuggestions", word, customDictionary,
                                                 ignoreUppercase, mainDictionary).toDispatch());
  }
  ...
  public short mountVolume(String zone, String server, String volume, Variant user, Variant userPassword,
    ...
    return Dispatch.call(this, "MountVolume", zone, server, volume, user, userPassword,
            volumePassword).changeType(Variant.VariantShort).getShort();
  }
   ...
   */
  public short mountVolume(String zone, String server, String volume, Variant user, Variant userPassword) {
    return Dispatch.call(this, "MountVolume", zone, server, volume, user, userPassword).changeType(Variant.VariantShort).
            getShort();
  }
  ...
  public float centimetersToPoints(float centimeters) {
    return Dispatch.call(this, "CentimetersToPoints", new Variant(centimeters)).changeType(Variant.VariantFloat).
            getFloat();
  }
  ...
  public float millimetersToPoints(float millimeters) {
    return Dispatch.call(this, "MillimetersToPoints", new Variant(millimeters)).changeType(Variant.VariantFloat).
            getFloat();
  }
  ...
  public float pointsToPixels(float points, Variant fVertical) {
    return Dispatch.call(this, "PointsToPixels", new Variant(points), fVertical).changeType(Variant.VariantFloat).
            getFloat();
  }
  ...
  public float pixelsToPoints(float pixels, Variant fVertical) {
    return Dispatch.call(this, "PixelsToPoints", new Variant(pixels), fVertical).changeType(Variant.VariantFloat).
            getFloat();
  }
  ...
  public void printOut(Variant background, Variant append, Variant range, Variant outputFileName, Variant from,
                       ...
                       Variant collate, Variant fileName, Variant activePrinterMacGX, Variant manualDuplexPrint,
                       Variant printZoomColumn, Variant printZoomRow, Variant printZoomPaperWidth,
  ...
  public void printOut(Variant background, Variant append, Variant range, Variant outputFileName, Variant from,
                       Variant to, Variant item, Variant copies, Variant pages, Variant pageType, Variant printToFile,
                       Variant collate, Variant fileName, Variant activePrinterMacGX, Variant manualDuplexPrint,
                       Variant printZoomColumn, Variant printZoomRow) {
    Dispatch.callN(this, "PrintOut", new Object[] {background, append, range, outputFileName, from, to, item, copies,
                   pages, pageType, printToFile, collate, fileName, activePrinterMacGX, manualDuplexPrint,
  ...
  public void printOut(Variant background, Variant append, Variant range, Variant outputFileName, Variant from,
                       Variant to, Variant item, Variant copies, Variant pages, Variant pageType, Variant printToFile,
                       Variant collate, Variant fileName, Variant activePrinterMacGX) {
    Dispatch.callN(this, "PrintOut", new Object[] {background, append, range, outputFileName, from, to, item, copies,
                   pages, pageType, printToFile, collate, fileName, activePrinterMacGX});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     Variant varg6, Variant varg7, Variant varg8, Variant varg9, Variant varg10, Variant varg11,
                     Variant varg12, Variant varg13, Variant varg14, Variant varg15, Variant varg16, Variant varg17,
                     Variant varg18, Variant varg19, Variant varg20, Variant varg21, Variant varg22, Variant varg23,
                     Variant varg24, Variant varg25, Variant varg26, Variant varg27, Variant varg28, Variant varg29,
                     Variant varg30) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17, varg18, varg19, varg20,
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
    ...
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17, varg18, varg19, varg20,
                          varg21, varg22, varg23, varg24, varg25, varg26, varg27, varg28, varg29});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     ...
                     Variant varg12, Variant varg13, Variant varg14, Variant varg15, Variant varg16, Variant varg17,
                     Variant varg18, Variant varg19, Variant varg20, Variant varg21, Variant varg22, Variant varg23,
                     Variant varg24, Variant varg25, Variant varg26, Variant varg27, Variant varg28) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17, varg18, varg19, varg20,
                          varg21, varg22, varg23, varg24, varg25, varg26, varg27, varg28});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     ...
                     Variant varg12, Variant varg13, Variant varg14, Variant varg15, Variant varg16, Variant varg17,
                     Variant varg18, Variant varg19, Variant varg20, Variant varg21, Variant varg22, Variant varg23,
                     Variant varg24, Variant varg25, Variant varg26, Variant varg27) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17, varg18, varg19, varg20,
                          varg21, varg22, varg23, varg24, varg25, varg26, varg27});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
    ...
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17, varg18, varg19, varg20,
                          varg21, varg22, varg23, varg24, varg25, varg26});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     Variant varg6, Variant varg7, Variant varg8, Variant varg9, Variant varg10, Variant varg11,
                     Variant varg12, Variant varg13, Variant varg14, Variant varg15, Variant varg16, Variant varg17,
                     Variant varg18, Variant varg19, Variant varg20, Variant varg21, Variant varg22) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17, varg18, varg19, varg20,
                          varg21, varg22});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     Variant varg6, Variant varg7, Variant varg8, Variant varg9, Variant varg10, Variant varg11,
                     Variant varg12, Variant varg13, Variant varg14, Variant varg15, Variant varg16, Variant varg17,
                     Variant varg18, Variant varg19, Variant varg20, Variant varg21) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17, varg18, varg19, varg20,
                          varg21});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     Variant varg6, Variant varg7, Variant varg8, Variant varg9, Variant varg10, Variant varg11,
                     Variant varg12, Variant varg13, Variant varg14, Variant varg15, Variant varg16, Variant varg17,
                     Variant varg18, Variant varg19) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17, varg18, varg19});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     ...
                     Variant varg18) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17, varg18});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     ...
                     Variant varg12, Variant varg13, Variant varg14, Variant varg15, Variant varg16, Variant varg17) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16, varg17});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     Variant varg6, Variant varg7, Variant varg8, Variant varg9, Variant varg10, Variant varg11,
                     Variant varg12, Variant varg13, Variant varg14, Variant varg15, Variant varg16) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15, varg16});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     Variant varg6, Variant varg7, Variant varg8, Variant varg9, Variant varg10, Variant varg11,
                     Variant varg12, Variant varg13, Variant varg14, Variant varg15) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14, varg15});
  }
  ...
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
    ...
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10, varg11, varg12, varg13, varg14});
  }
   ...
   */
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     Variant varg6, Variant varg7, Variant varg8, Variant varg9, Variant varg10) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9, varg10});
  }
   ...
   */
  public Variant run(String macroName, Variant varg1, Variant varg2, Variant varg3, Variant varg4, Variant varg5,
                     Variant varg6, Variant varg7, Variant varg8, Variant varg9) {
    return Dispatch.callN(this, "Run", new Object[] {macroName, varg1, varg2, varg3, varg4, varg5, varg6, varg7, varg8,
                          varg9});
  }
