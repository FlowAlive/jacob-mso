...
public class Column extends Dispatch {
  ...
  public void sort(Variant excludeHeader, Variant sortFieldType, Variant sortOrder, Variant caseSensitive,
                   Variant bidiSort, Variant ignoreThe, Variant ignoreKashida, Variant ignoreDiacritics,
                   Variant ignoreHe, Variant languageID) {
    Dispatch.callN(this, "Sort", new Object[] {excludeHeader, sortFieldType, sortOrder, caseSensitive, bidiSort,
  ...
  public void sort(Variant excludeHeader, Variant sortFieldType, Variant sortOrder, Variant caseSensitive,
    ...
    Dispatch.call(this, "Sort", excludeHeader, sortFieldType, sortOrder, caseSensitive, bidiSort, ignoreThe,
                  ignoreKashida, ignoreDiacritics);
  }
   ...
   */
  public void sort(Variant excludeHeader, Variant sortFieldType, Variant sortOrder, Variant caseSensitive,
                   Variant bidiSort, Variant ignoreThe, Variant ignoreKashida) {
    Dispatch.call(this, "Sort", excludeHeader, sortFieldType, sortOrder, caseSensitive, bidiSort, ignoreThe,
                  ignoreKashida);
  }
   ...
   */
  public void sort(Variant excludeHeader, Variant sortFieldType, Variant sortOrder, Variant caseSensitive,
                   Variant bidiSort, Variant ignoreThe) {
    Dispatch.call(this, "Sort", excludeHeader, sortFieldType, sortOrder, caseSensitive, bidiSort, ignoreThe);
  }
