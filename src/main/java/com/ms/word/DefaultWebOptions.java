...
public class DefaultWebOptions extends Dispatch {
  ...
  public static final String componentName = "Word.DefaultWebOptions";
   ...
   * @return the result is of type boolean
   */
  public boolean getUpdateLinksOnSave() {
    return Dispatch.get(this, "UpdateLinksOnSave").changeType(Variant.VariantBoolean).getBoolean();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param updateLinksOnSave an input-parameter of type boolean
   */
  public void setUpdateLinksOnSave(boolean updateLinksOnSave) {
    Dispatch.put(this, "UpdateLinksOnSave", new Variant(updateLinksOnSave));
  }
   ...
   * @return the result is of type boolean
   */
  public boolean getCheckIfOfficeIsHTMLEditor() {
    return Dispatch.get(this, "CheckIfOfficeIsHTMLEditor").changeType(Variant.VariantBoolean).getBoolean();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param checkIfOfficeIsHTMLEditor an input-parameter of type boolean
   */
  public void setCheckIfOfficeIsHTMLEditor(boolean checkIfOfficeIsHTMLEditor) {
    Dispatch.put(this, "CheckIfOfficeIsHTMLEditor", new Variant(checkIfOfficeIsHTMLEditor));
  }
   ...
   * @return the result is of type boolean
   */
  public boolean getCheckIfWordIsDefaultHTMLEditor() {
    return Dispatch.get(this, "CheckIfWordIsDefaultHTMLEditor").changeType(Variant.VariantBoolean).getBoolean();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param checkIfWordIsDefaultHTMLEditor an input-parameter of type boolean
   */
  public void setCheckIfWordIsDefaultHTMLEditor(boolean checkIfWordIsDefaultHTMLEditor) {
    Dispatch.put(this, "CheckIfWordIsDefaultHTMLEditor", new Variant(checkIfWordIsDefaultHTMLEditor));
  }
   ...
   * @return the result is of type boolean
   */
  public boolean getAlwaysSaveInDefaultEncoding() {
    return Dispatch.get(this, "AlwaysSaveInDefaultEncoding").changeType(Variant.VariantBoolean).getBoolean();
  }

  /**
   * Wrapper for calling the ActiveX-Method with input-parameter(s).
   * @param alwaysSaveInDefaultEncoding an input-parameter of type boolean
   */
  public void setAlwaysSaveInDefaultEncoding(boolean alwaysSaveInDefaultEncoding) {
    Dispatch.put(this, "AlwaysSaveInDefaultEncoding", new Variant(alwaysSaveInDefaultEncoding));
  }
